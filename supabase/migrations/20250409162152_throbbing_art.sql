/*
  # Fix GFE Timings Table and Functions

  1. Changes
    - Add indexes for commonly queried columns
    - Update calculate_wait_time function to handle all timing scenarios
    - Add trigger for tracking queue entries
    - Fix field references in functions
...
-- Update existing records with null queued_at
UPDATE gfe_timings
